...
/**
 * @Class Name : MngWaterInsepectionController.java
 * @Description : MngWaterInsepectionController Class
...
@Controller
public class MngWaterInsepectionController {
	...
	/**
	 * 시설보안 - 검침기록 관리 - 수도검침 페이지로 포워딩한다.
	 * @param model
	 * @param hshldCmnuseVO
	 * @return 수도검침 페이지
	 */
	@GetMapping("/mngwtrmtinsp")
	public String selectOneHshldCmnuse(Model model, HshldCmnuseVO hshldCmnuseVO) {
		...
		// 특정 연월, 호수의 관리비 정보
		// /mngwtrmtinsp/detail?rlvtYm=202307&hshldInfoNo=101101
	 ...
	 * @return 세대관리비 등록 페이지
	 */
	@GetMapping("/mngwtrmtinsp/register")
	 ...
	 */
	@ResponseBody
	@GetMapping("/mngwtrmtinsp/detail.ajax")
