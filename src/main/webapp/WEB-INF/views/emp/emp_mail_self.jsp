	...
	<div class="mail-intro-y inbox box mt-5" style="letter-spacing: 0px;">
		...
		<div class="overflow-x-auto sm:overflow-x-visible">
			<c:forEach var="emailVO" items="${data.content}" varStatus="status">
				<c:set var="mailState" value="${emailVO.rcvrSttsCd}" />
				<c:if test="${mailState eq 'ESMS04'}">
							...
							<div class="flex px-5 py-3">
								<div class="w-72 flex-none flex items-center mr-5">
									<input class="form-check-input flex-none emailCheckbox"
										...
										<img alt="" class="favoritEmails"
										src="/resources/images/popular4x_86988.png"
										style="width: 18px; height: 18px;"
										data-value="${emailVO.emlId}" />
									</a> <a href="javascript:;"
								...
								<div class="w-64 sm:w-auto truncate">
									<span class="inbox__item--highlight" onclick='mailDetail(
										"${emailVO.emlId}")'> ${emailVO.emlTitle} </span>
								</div>
				...
				<nav class="w-full sm:w-auto sm:mr-auto">
					<ul class="pagination">
						...
						<li class="page-item"><a class="page-link"
							href="/emp/mail/self?currentPage=1"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
						...
						<li class="page-item"><a class="page-link"
							...
							href="/emp/mail/self?currentPage=${data.startPage-5}&size=${param.size}&cond=${param.cond}&keyword=${param.keyword}">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
									icon-name="chevron-left"
		            	...
		            	">
								<a
								href="/emp/mail/self?currentPage=${pNo}&size=${param.size}&cond=${param.cond}&keyword=${param.keyword}"
						...
						<li class="page-item"><a class="page-link"
							...
							href="/emp/mail/inbox?currentPage=${data.startPage+5}&size=${param.size}&cond=${param.cond}&keyword=${param.keyword}">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
									icon-name="chevron-right"
						...
						<li class="page-item"><a class="page-link"
							<c:if test='${data.endPage == data.totalPages}'>style="pointer-events: none;"</c:if>
							href="/emp/mail/self?currentPage=${data.totalPages}"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
<script type="text/javascript">
	...
	function mailDetail(emailId) {
		console.log(emailId);
		location.href = "/emp/mail/inbox/mailDetail?emlId=" + emailId;
	}
</script>
