...
<div class="bdy col-span-12 lg:col-span-9 2xl:col-span-10">
	...
	<h5 class="text-lg font-medium leading-none mt-0 mr-auto">메일 &gt;
		즐겨찾기</h5>
	<div class="mail-mail-intro-y flex flex-col-reverse sm:flex-row mt-3">
				...
				<nav class="w-full sm:w-auto sm:mr-auto">
					<ul class="pagination">
						...
						<li class="page-item"><a class="page-link"
							href="/emp/mail/favorite?currentPage=1"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
						...
						<li class="page-item"><a class="page-link"
							...
							href="/emp/mail/favorite?currentPage=${data.startPage-5}&size=${param.size}&cond=${param.cond}&keyword=${param.keyword}">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
									icon-name="chevron-left"
		            	...
		            	">
								<a
								href="/emp/mail/favorite?currentPage=${pNo}&size=${param.size}&cond=${param.cond}&keyword=${param.keyword}"
						...
						<li class="page-item"><a class="page-link"
							<c:if test='${data.endPage == data.totalPages}'>style="pointer-events: none;"</c:if>
							href="/emp/mail/favorite?currentPage=${data.totalPages}"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
					...
					jQuery.ajax({
						...
						success: function(result){
							...
							if(result == checkMailList.length){
								alert("삭제가 완료되었습니다.");
								location.href="/emp/mail/favorite";
							}
