...
<form id="frm" method="get" enctype="multipart/form-data">
	<div class="intro-y news p-5 box mt-0">
		<h2 class="intro-y font-medium text-xl sm:text-2xl" style="margin-left:15px;">
			${sttPostDetail[0].pstSj}&nbsp;
			<span class="absolute top-0 bg-red-700 bg-opacity-80 text-white text-xs m-1 px-2 py-1 rounded z-10">신고 횟수 : ${sttCnt.cnt}</span>
		</h2>
		<div class="intro-y flex relative pt-16 sm:pt-6 items-center pb-6 -mt-0">

		    <div class="absolute sm:relative -mt-12 sm:mt-0 w-full flex text-slate-600 dark:text-slate-500 text-xs sm:text-sm" style="margin-left: 15px;" >
		        <div class="text-xl font-medium leading-none mt-3">작성자 : ${sttPostDetail[0].frstWrterId}<span class="font-medium"></span> </div>
		    </div>
		    <div class="absolute sm:relative -mt-12 sm:mt-0 w-full flex justify-end text-slate-600 dark:text-slate-500 text-xs sm:text-sm">
			    <button type="button" id="btnDelete" class="btn btn-outline-primary" value="${sttPostDetail[0].sttemntPstId}">삭제</button>
		    </div>
		</div>
		<hr/>
		<table class="table">
		...
		<div class="intro-y flex text-xs sm:text-sm flex-col sm:flex-row items-center mt-0 pt-5 border-t border-slate-200/60 dark:border-darkmode-400">
			<div class="flex items-center">
				<div class="ml-3 mr-auto">
					<h6 class="font-medium leading-none mt-3">판매가 :<fmt:formatNumber value='${sttPostDetail[0].scndhandPc}' type="number"/>원</h6>
				</div>
			</div>
			<div class="flex items-center" style="margin-left: 700px;">
				<h6 class="font-medium leading-none mt-3">조회수 : ${sttPostDetail[0].rdcnt}</h6>
			</div>
			<div class="flex items-center text-slate-600 dark:text-slate-500 sm:ml-auto mt-5 sm:mt-0">
<%-- 					<h6 class="font-medium leading-none mt-3">작성일 : ${sttPostDetail[0].fsrtWritingTm}</h6> --%>
			</div>
		</div>
