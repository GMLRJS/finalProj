...
<div class="bdy col-span-12 lg:col-span-9 2xl:col-span-10">
	<div class="intro-y flex flex-col sm:flex-row items-center mt-0">
		<h5 class="text-lg font-medium leading-none mt-0 mr-auto">경리/회계
			> 외주업체 관리</h5>
...
$(function(){
	if ($("#test").length) {
	    ...
	    var table = new Tabulator("#test", {
			...
			ajaxURL: "/emp/aa/mngagency/agencyList",
			ajaxFiltering: false,
			ajaxSorting: false,
			printAsHtml: true,
			printStyled: true,
	             ...
	             cssClass: "font-bold",
	              formatter: function(cell, formatterParams) {
	                 ...
	                 <div class="flex lg:justify-center items-center">
	                    <a class="detail" href="javascript:;" title=${txt}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="more-vertical" data-lucide="more-vertical" class="lucide lucide-more-vertical block mx-auto"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg></a>
	                 </div>
	                 `);

	                $(icons).find(".detail").on("click", function() {
