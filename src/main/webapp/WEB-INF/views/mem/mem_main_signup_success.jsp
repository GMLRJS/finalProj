...
<div class="bdy col-span-11 bg-white mt-10 mb-10">
	<div
		...
		<h2 class="intro-x font-bold text-3xl text-center" style="margin-top: 100px;">회원가입 신청 성공!</h2>
		<h2 class="intro-x text-xl text-center" style="margin-top: 50px; margin-bottom: 100px;">관리자의 승인 후 로그인이 가능합니다.</h2>
	</div>
</div>
<!-- END: Body -->
