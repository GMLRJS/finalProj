...
<form id="frm" action="/mem/life/library/registerPost?${_csrf.parameterName}=${_csrf.token}"
	...
	<div class="intro-y box p-5">
	    ...
	    <div>
	        ...
	        <input id="crud-form-1" name="bookSj" type="text" class="form-control w-full text-lg font-semibold mt-1">
	    </div>
	    <div>
	        <label for="crud-form-1" class="form-label text-xl font-semibold mt-3">저자</label>
	        <input id="crud-form-1" name="authr" type="text" class="form-control w-full text-lg font-semibold mt-1">
	    </div>
	    <div>
	        <label for="crud-form-1" class="form-label text-xl font-semibold mt-3">재고 수</label>
	        <input id="crud-form-1" name="invntry" type="text" class="form-control w-full text-lg font-semibold mt-1">
	    </div>
		<div class="mt-3">
		...
		<div class="text-right mt-5">
	        <button type="submit" id="btnReg" class="btn btn-primary w-24 mr-1">등록</button>
