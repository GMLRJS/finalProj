...
$(document).ready(function(){
	//해당 클래스를 가진 버튼에 이벤트 리스너 추가
	$('button.rounded').on('click', function(e) {
	  	console.log(e.target.innerText);

	  	let emoji = e.target.innerText;
		let oldMsg = $("#chatTextArea").val();
		let newMsg = oldMsg + emoji;
		$("#chatTextArea").val(newMsg);
	});
...
<div class="dropdown mr-3 sm:mr-5">
	...
	<a href="javascript:"
		...
		aria-expanded="false" data-tw-toggle="dropdown"> <svg
			...
			class="lucide lucide-smile w-full h-full">
	...
	<div class="chat-dropdown dropdown-menu">
		<div class="dropdown-content">
			<div class="chat-dropdown__box flex flex-col">
				...
				<ul class="chat-dropdown__box__tabs nav nav-pills px-1 mt-5"
					role="tablist">
						...
						<div class="h-full pb-10 overflow-y-auto scrollbar-hidden mt-2">
							<div class="grid grid-cols-8 text-2xl">
								...
								<button
									class="rounded focus:outline-none hover:bg-slate-100 dark:hover:bg-darkmode-400">🕵️</button>
								<button
									class="rounded focus:outline-none hover:bg-slate-100 dark:hover:bg-darkmode-400">🕵️‍♂️</button>
								<button
									class="rounded focus:outline-none hover:bg-slate-100 dark:hover:bg-darkmode-400">🕵️‍♀️</button>
								<button
									class="rounded focus:outline-none hover:bg-slate-100 dark:hover:bg-darkmode-400">💂</button>
